...
@app.route('/')
def main():
    code = Markup("#include< iostream.h ><br>typedef void(*FunPtr)(int);<br>int Look(int = 10, int = 20);<br>void Note(int);<br>int main()<br>{<br>FunPtr ptr = Note;<br>(*ptr)(30);<br>return 0;<br>}<br>int Look(int x, int y)<br>{<br>return(x + y % 20);<br>}<br>void Note(int x)")

    # params = {'ques':'Who is the President of United States of America ?', 'quesImage': 'code.png'}
    params = {'ques':code, 'quesImage': '22.jpg'}
